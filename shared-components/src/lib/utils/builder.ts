...
export class EventParamsBuilder
  extends GqlParamsBuilder
  implements ExtendedBuilder
{
  constructor() {
...
export class EventProdParamsBuilder
  extends GqlParamsBuilder
  implements ExtendedBuilder
{
  constructor() {
...
export class EventReceiverParamsBuilder
  extends GqlParamsBuilder
  implements ExtendedBuilder
{
  constructor() {
